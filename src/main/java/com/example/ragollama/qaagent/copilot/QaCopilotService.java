...
import com.example.ragollama.qaagent.impl.ExplainerAgent;
...
public class QaCopilotService {
    ...
    private Mono<CopilotResponse> handleExplanationRequest(CopilotRequest request, CopilotSession session, UUID sessionId) {
        ...
        com.example.ragollama.qaagent.AgentContext explainerContext = new com.example.ragollama.qaagent.AgentContext(Map.of(
