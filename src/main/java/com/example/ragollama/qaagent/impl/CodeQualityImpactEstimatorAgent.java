...
import com.example.ragollama.qaagent.model.CodeQualityImpactReport;
...
public class CodeQualityImpactEstimatorAgent implements QaAgent {
        ...
        return Flux.fromIterable(changedFiles)
                ...
                .flatMap(profiles -> {
                    ...
                    try {
                        ...
                        String promptString = promptService.render("codeQualityImpact", Map.of("riskDataJson", profilesJson));
