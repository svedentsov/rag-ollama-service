...
import com.example.ragollama.qaagent.tools.JiraIssueDto;
...
public class JiraFetcherAgent implements QaAgent {

    /**
     * Ключ в {@link AgentContext}, по которому агент ищет идентификатор задачи Jira.
     */
     ...
     * <p>
     * В случае успеха, обогащает контекст, добавляя в него полный текст задачи
     * под ключом "bugReportText", что позволяет следующим агентам, таким как
     * {@link BugDuplicateDetectorAgent}, использовать эти данные.
     *
