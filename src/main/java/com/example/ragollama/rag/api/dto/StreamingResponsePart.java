...
public sealed interface StreamingResponsePart {
     ...
     * @param sources Список уникальных имен источников.
     */
    @Schema(description = "Список документов-источников, использованных для ответа")
    record Sources(List<String> sources) implements StreamingResponsePart {}
