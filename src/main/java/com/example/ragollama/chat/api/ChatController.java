...
import com.example.ragollama.shared.exception.GlobalExceptionHandler;
...
public class ChatController {
     ...
     * Обработка исключений делегирована глобальному обработчику {@link GlobalExceptionHandler}.
     *
