 ...
 * <p>
 * Этот класс формализует процесс аудита как явный, именованный конвейер,
 * что соответствует принципам Clean Architecture и упрощает вызов из контроллера.
 * Конвейер состоит из одного этапа, содержащего одного агента-аудитора.
 */
@Component
