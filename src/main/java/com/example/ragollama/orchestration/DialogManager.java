 ...
 * <p>
 * Этот сервис является результатом рефакторинга для соблюдения принципов
 ...
 * <p>
 * Такая декомпозиция делает систему более модульной, тестируемой и легкой для понимания и поддержки.
 */
@Service
@Slf4j
...
public class DialogManager {
     ...
     * <p>
     * Этот метод атомарно выполняет три действия:
     * <ol>
